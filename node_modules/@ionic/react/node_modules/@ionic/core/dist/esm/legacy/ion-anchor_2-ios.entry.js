...
import { r as registerInstance, f as getContext, d as getIonMode, h, H as Host, j as getElement } from './ionic-7d8dfe6a.js';
import { o as openURL, c as createColorClasses } from './chunk-f71db699.js';
...
var BackButton = /** @class */ (function () {
    ...
    BackButton.prototype.hostData = function () {
        ...
        var mode = getIonMode(this);
        return {
            class: Object.assign({}, createColorClasses(this.color), (_a = {}, _a["" + mode] = true, _a['button'] = true, _a['ion-activatable'] = true, _a['show-back-button'] = showBackButton, _a))
        };
    };
    BackButton.prototype.__stencil_render = function () {
        var mode = getIonMode(this);
        var defaultBackButtonText = mode === 'ios' ? 'Back' : null;
    ...
    BackButton.prototype.render = function () { return h(Host, this.hostData(), this.__stencil_render()); };
...
export { Anchor as ion_anchor, BackButton as ion_back_button };
