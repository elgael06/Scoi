import { r as registerInstance, e as createEvent, d as getIonMode, j as getElement, h, H as Host } from './ionic-7d8dfe6a.js';
import { c as createColorClasses } from './chunk-f71db699.js';
/**
...
var SegmentButton = /** @class */ (function () {
    ...
    SegmentButton.prototype.hostData = function () {
        var _a;
        var _b = this, checked = _b.checked, disabled = _b.disabled, hasIcon = _b.hasIcon, hasLabel = _b.hasLabel, layout = _b.layout;
        var mode = getIonMode(this);
        return {
    ...
    SegmentButton.prototype.__stencil_render = function () {
        var mode = getIonMode(this);
        return [
    ...
    SegmentButton.prototype.render = function () { return h(Host, this.hostData(), this.__stencil_render()); };
