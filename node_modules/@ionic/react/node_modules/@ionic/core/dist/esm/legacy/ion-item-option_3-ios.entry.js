...
import { r as registerInstance, d as getIonMode, h, j as getElement, H as Host, e as createEvent, f as getContext } from './ionic-7d8dfe6a.js';
import { c as createColorClasses } from './chunk-f71db699.js';
import { i as isEndSide } from './chunk-46cb4989.js';
/**
...
var ItemOption = /** @class */ (function () {
    ...
    ItemOption.prototype.onClick = function (ev) {
    ...
    ItemOption.prototype.hostData = function () {
        ...
        var _b = this, disabled = _b.disabled, expandable = _b.expandable;
        return {
            class: Object.assign({}, createColorClasses(this.color), (_a = {}, _a["" + mode] = true, _a['item-option-disabled'] = disabled, _a['item-option-expandable'] = expandable, _a['ion-activatable'] = true, _a))
        };
    };
    ItemOption.prototype.__stencil_render = function () {
    ...
    ItemOption.prototype.render = function () { return h(Host, this.hostData(), this.__stencil_render()); };
