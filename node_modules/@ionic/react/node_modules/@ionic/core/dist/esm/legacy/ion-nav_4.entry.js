            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.rootChanged();
                        _a = this;
                        return [4 /*yield*/, import('./swipe-back-1d9576c2.js')];
                    case 1:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        animationOpts = Object.assign({ mode: mode, showGoBack: this.canGoBackSync(enteringView), window: this.win, baseEl: this.el, animationBuilder: this.animation || opts.animationBuilder || this.config.get('navAnimation'), progressCallback: progressCallback, animated: this.animated && this.config.getBoolean('animated', true), enteringEl: enteringEl,
