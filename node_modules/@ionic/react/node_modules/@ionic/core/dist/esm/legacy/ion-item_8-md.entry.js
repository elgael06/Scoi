...
import { r as registerInstance, f as getContext, d as getIonMode, h, j as getElement, H as Host, e as createEvent } from './ionic-7d8dfe6a.js';
import { c as createColorClasses, h as hostContext, o as openURL } from './chunk-f71db699.js';
/**
...
var Item = /** @class */ (function () {
    ...
    Item.prototype.hostData = function () {
        ...
        return {
            ...
            class: Object.assign({}, childStyles, createColorClasses(this.color), (_a = { 'item': true }, _a["" + mode] = true, _a["item-lines-" + this.lines] = this.lines !== undefined, _a['item-disabled'] = this.disabled, _a['in-list'] = hostContext('ion-list', this.el), _a['item-multiple-inputs'] = this.multipleInputs, _a['ion-activatable'] = this.isClickable(), _a['ion-focusable'] = true, _a))
        };
    };
    Item.prototype.__stencil_render = function () {
        var mode = getIonMode(this);
        var _a = this, href = _a.href, detail = _a.detail, win = _a.win, detailIcon = _a.detailIcon, routerDirection = _a.routerDirection, type = _a.type;
        ...
        return [
            h(TagType, Object.assign({}, attrs, { class: "item-native", disabled: this.disabled, onClick: function (ev) { return openURL(win, href, ev, routerDirection); } }), h("slot", { name: "start" }), h("div", { class: "item-inner" }, h("div", { class: "input-wrapper" }, h("slot", null)), h("slot", { name: "end" }), showDetail && h("ion-icon", { icon: detailIcon, lazy: false, class: "item-detail-icon" }), h("div", { class: "item-inner-highlight" })), clickable && mode === 'md' && h("ion-ripple-effect", null)),
...
var SkeletonText = /** @class */ (function () {
    ...
    SkeletonText.prototype.hostData = function () {
        var _a;
        var animated = this.animated && this.config.getBoolean('animated', true);
