import { r as registerInstance, e as createEvent, f as getContext, d as getIonMode$1, h, j as getElement, H as Host, l as getMode, m as getAssetPath } from './ionic-7d8dfe6a.js';
import { o as openURL, c as createColorClasses$1 } from './chunk-f71db699.js';
import { h as hasShadowDom } from './chunk-46cb4989.js';
/**
...
var Button = /** @class */ (function () {
    ...
    Button.prototype.hostData = function () {
        ...
        var _b = this, buttonType = _b.buttonType, disabled = _b.disabled, color = _b.color, expand = _b.expand, hasIconOnly = _b.hasIconOnly, shape = _b.shape, size = _b.size, strong = _b.strong;
        var fill = this.fill;
        if (fill === undefined) {
        ...
        return {
            ...
            class: Object.assign({}, createColorClasses$1(color), (_a = {}, _a["" + mode] = true, _a[buttonType] = true, _a[buttonType + "-" + expand] = expand !== undefined, _a[buttonType + "-" + size] = size !== undefined, _a[buttonType + "-" + shape] = shape !== undefined, _a[buttonType + "-" + fill] = true, _a[buttonType + "-strong"] = strong, _a['button-has-icon-only'] = hasIconOnly, _a['button-disabled'] = disabled, _a['ion-activatable'] = true, _a['ion-focusable'] = true, _a))
        };
    };
