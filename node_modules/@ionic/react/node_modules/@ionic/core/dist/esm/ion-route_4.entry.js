import { r as registerInstance, e as createEvent, f as getContext, j as getElement, d as getIonMode, h } from './ionic-7d8dfe6a.js';
import './chunk-94c4865f.js';
import { e as debounce } from './chunk-46cb4989.js';
import { a as attachComponent, d as detachComponent } from './chunk-25340090.js';
import { t as transition } from './chunk-85d5c658.js';
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await import('./swipe-back-1d9576c2.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
...
export { Route as ion_route, RouteRedirect as ion_route_redirect, Router as ion_router, RouterOutlet as ion_router_outlet };
