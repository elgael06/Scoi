...
import { r as registerInstance, e as createEvent, f as getContext, d as getIonMode, h, j as getElement, H as Host } from './ionic-7d8dfe6a.js';
import { c as createColorClasses } from './chunk-f71db699.js';
import { s as sanitizeDOMString } from './chunk-cae2ca23.js';
import { d as debounceEvent } from './chunk-46cb4989.js';
/**
...
var Searchbar = /** @class */ (function () {
    ...
    Searchbar.prototype.hostData = function () {
        ...
        return {
            ...
            class: Object.assign({}, createColorClasses(this.color), (_a = {}, _a["" + mode] = true, _a['searchbar-animated'] = animated, _a['searchbar-disabled'] = this.disabled, _a['searchbar-no-animate'] = animated && this.noAnimate, _a['searchbar-has-value'] = this.hasValue(), _a['searchbar-left-aligned'] = this.shouldAlignLeft, _a['searchbar-has-focus'] = this.focused, _a))
        };
    };
    Searchbar.prototype.__stencil_render = function () {
        ...
        var cancelButton = this.showCancelButton && (h("button", { type: "button", tabIndex: mode === 'ios' && !this.focused ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" }, h("div", null, mode === 'md'
