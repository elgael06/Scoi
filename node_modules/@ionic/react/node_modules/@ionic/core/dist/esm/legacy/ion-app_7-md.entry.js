...
import { r as registerInstance, f as getContext, d as getIonMode, j as getElement, h, H as Host, i as isPlatform, e as createEvent } from './ionic-7d8dfe6a.js';
import { c as createColorClasses, h as hostContext } from './chunk-f71db699.js';
import { a as rIC } from './chunk-46cb4989.js';
...
function importHardwareBackButton(win, config) {
    ...
    if (hardwareBackConfig) {
        import('./hardware-back-button-3665b9c9.js').then(function (module) { return module.startHardwareBackButton(win); });
    }
}
function importStatusTap(win, config) {
    var statusTap = config.getBoolean('statusTap', isPlatform(win, 'hybrid'));
    if (statusTap) {
        import('./status-tap-873bae51.js').then(function (module) { return module.startStatusTap(win); });
    }
}
function importFocusVisible(win) {
    import('./focus-visible-18cc44a1.js').then(function (module) { return module.startFocusVisible(win.document); });
}
function importTapClick(win, config) {
    import('./tap-click-753562d9.js').then(function (module) { return module.startTapClick(win.document, config); });
}
function importInputShims(win, config) {
    var inputShims = config.getBoolean('inputShims', needInputShims(win));
    if (inputShims) {
        import('./input-shims-3d5f1b9c.js').then(function (module) { return module.startInputShims(win.document, config); });
    }
}
...
var Content = /** @class */ (function () {
    ...
    Content.prototype.__stencil_render = function () {
        var _this = this;
    ...
    Content.prototype.render = function () { return h(Host, this.hostData(), this.__stencil_render()); };
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.__stencil_render = function () {
        return [
    ...
    Toolbar.prototype.render = function () { return h(Host, this.hostData(), this.__stencil_render()); };
