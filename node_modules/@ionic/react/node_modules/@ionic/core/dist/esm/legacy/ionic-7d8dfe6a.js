    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, import('./shadow-css-984bac74-a7bddb6a.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 2:
                style_1 = _a.sent();
                _a.label = 3;
            case 3:
...
var isPlatform = function (win, platform) { return getPlatforms(win).includes(platform); };
...
var config = Context.config = new Config();
var mode;
...
function global0() {
    ...
    setMode(function (elm) { return elm.mode || elm.getAttribute('mode') || mode; });
}
setMode(function (el) { return el.tagName === 'ION-ICON' ? el.mode || el.getAttribute('mode') : null; });
function globals() {
    global0();
}
export { Host as H, PLATFORMS_MAP as P, patchEsm as a, bootstrapLazy as b, getPlatforms as c, getIonMode as d, createEvent as e, getContext as f, globals as g, h, isPlatform as i, getElement as j, readTask as k, getMode as l, getAssetPath as m, getConnect as n, config as o, patchBrowser as p, registerInstance as r, setupPlatforms as s, testUserAgent as t, writeTask as w };
