...
const patchBrowser = async () => {
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('ionic-e1db78f3.js', document.baseURI).href));
    if (importMeta !== '') {
    ...
    if ((hostRef.$flags$ & 256 /* hasInitializedComponent */) === 0) {
        ...
        if (!Cstr.isStyleRegistered && Cstr.style) {
            ...
            if (cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await Promise.resolve(require('./shadow-css-984bac74-70fe0e61.js')).then(m => m.scopeCss(style, scopeId, false));
            }
...
exports.Host = Host;
exports.PLATFORMS_MAP = PLATFORMS_MAP;
