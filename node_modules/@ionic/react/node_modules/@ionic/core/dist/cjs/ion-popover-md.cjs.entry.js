...
class Popover {
    ...
    onBackdropTap() {
        this.dismiss(undefined, __chunk_3.BACKDROP);
    }
    ...
    async present() {
        ...
        this.usersElement = await __chunk_7.attachComponent(this.delegate, container, this.component, ['popover-viewport', this.el['s-sc']], data);
        await __chunk_8.deepReady(this.usersElement);
        return __chunk_3.present(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, this.event);
    }
    /**
    ...
    async dismiss(data, role) {
        const shouldDismiss = await __chunk_3.dismiss(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
        if (shouldDismiss) {
            await __chunk_7.detachComponent(this.delegate, this.usersElement);
        }
     ...
     */
    onDidDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionPopoverDidDismiss');
    }
    /**
     * Returns a promise that resolves when the popover will dismiss.
     */
    onWillDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionPopoverWillDismiss');
    }
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_4.getClassMap(this.cssClass), { [`${mode}`]: true, 'popover-translucent': this.translucent })
        };
    }
    __stencil_render() {
        return [
