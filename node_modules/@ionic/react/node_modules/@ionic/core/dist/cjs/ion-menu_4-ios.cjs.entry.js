...
const index = require('./index-e432ed5f.js');
...
class Menu {
    ...
    sideChanged() {
        this.isEndSide = __chunk_6.isEndSide(window, this.side);
    }
    swipeGestureChanged() {
        this.updateState();
    }
    ...
    onStart() {
        if (!this.isAnimating || !this.animation) {
            __chunk_6.assert(false, 'isAnimating has to be true');
            return;
        }
    ...
    beforeAnimation(shouldOpen) {
        __chunk_6.assert(!this.isAnimating, '_before() should not be called while animating');
    ...
    afterAnimation(isOpen) {
        __chunk_6.assert(this.isAnimating, '_before() should be called while animating');
    ...
    updateState() {
        ...
        __chunk_6.assert(!this.isAnimating, 'can not be animating');
    }
    forceClosing() {
        __chunk_6.assert(this._isOpen, 'menu cannot be closed');
        this.isAnimating = true;
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { role: "complementary", class: {
                [`menu-type-${type}`]: true,
                'menu-enabled': !disabled,
                'menu-side-end': isEndSide,
                'menu-side-start': !isEndSide,
                'menu-pane-visible': isPaneVisible
            } }, __chunk_1.h("div", { class: "menu-inner", ref: el => this.menuInnerEl = el }, __chunk_1.h("slot", null)), __chunk_1.h("ion-backdrop", { ref: (el) => this.backdropEl = el, class: "menu-backdrop", tappable: false, stopPropagation: false })));
    }
...
class MenuButton {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { [`${mode}`]: true, 'button': true, 'ion-activatable': true, 'ion-focusable': true })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
        const menuIcon = this.config.get('menuIcon', 'menu');
        return (__chunk_1.h("ion-menu-toggle", { menu: this.menu, autoHide: this.autoHide }, __chunk_1.h("button", { type: "button", class: "button-native" }, __chunk_1.h("slot", null, __chunk_1.h("ion-icon", { icon: menuIcon, mode: mode, lazy: false })), mode === 'md' && __chunk_1.h("ion-ripple-effect", { type: "unbounded" }))));
    }
...
class MenuController {
    ...
    async _createAnimation(type, menuCmp) {
        ...
        const animation = await Promise.resolve(require('./index-7a1c7008.js'))
