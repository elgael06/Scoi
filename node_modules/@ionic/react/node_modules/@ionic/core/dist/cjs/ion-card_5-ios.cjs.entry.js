...
class Card {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({ [`${mode}`]: true }, __chunk_4.createColorClasses(this.color), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() })
        };
    }
    __stencil_render() {
        ...
        return (__chunk_1.h(TagType, Object.assign({}, attrs, { class: "card-native", disabled: this.disabled, onClick: (ev) => __chunk_4.openURL(win, href, ev, routerDirection) }), __chunk_1.h("slot", null), clickable && mode === 'md' && __chunk_1.h("ion-ripple-effect", null)));
    }
...
class CardHeader {
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { 'card-header-translucent': this.translucent, [`${mode}`]: true })
        };
    }
    __stencil_render() {
