...
class FabButton {
    ...
    hostData() {
        ...
        const inList = __chunk_4.hostContext('ion-fab-list', el);
        const mode = __chunk_1.getIonMode(this);
        return {
