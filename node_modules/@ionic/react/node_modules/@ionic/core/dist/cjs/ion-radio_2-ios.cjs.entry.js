...
class Radio {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_4.createColorClasses(color), { [`${mode}`]: true, 'in-item': __chunk_4.hostContext('ion-item', el), 'interactive': true, 'radio-checked': checked, 'radio-disabled': disabled })
        };
    }
    __stencil_render() {
        return [
            __chunk_1.h("div", { class: "radio-icon" }, __chunk_1.h("div", { class: "radio-inner" })),
            __chunk_1.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled }),
        ];
    }
