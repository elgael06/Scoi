...
class Searchbar {
    ...
    positionPlaceholder() {
        ...
        if (this.shouldAlignLeft) {
            ...
            tempSpan.innerHTML = __chunk_5.sanitizeDOMString(this.placeholder) || '';
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { [`${mode}`]: true, 'searchbar-animated': animated, 'searchbar-disabled': this.disabled, 'searchbar-no-animate': animated && this.noAnimate, 'searchbar-has-value': this.hasValue(), 'searchbar-left-aligned': this.shouldAlignLeft, 'searchbar-has-focus': this.focused })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
        ...
        const cancelButton = this.showCancelButton && (__chunk_1.h("button", { type: "button", tabIndex: mode === 'ios' && !this.focused ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" }, __chunk_1.h("div", null, mode === 'md'
