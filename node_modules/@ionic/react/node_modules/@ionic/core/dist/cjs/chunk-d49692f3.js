...
const iosTransitionAnimation = () => Promise.resolve(require('./ios.transition-73e77d60.js'));
const mdTransitionAnimation = () => Promise.resolve(require('./md.transition-77e6270e.js'));
...
async function animation(animationBuilder, opts) {
    ...
    const trans = await Promise.resolve(require('./index-7a1c7008.js')).then(mod => mod.create(animationBuilder, opts.baseEl, opts));
...
function fireWillEvents(enteringEl, leavingEl) {
    lifecycle(leavingEl, __chunk_2.LIFECYCLE_WILL_LEAVE);
    lifecycle(enteringEl, __chunk_2.LIFECYCLE_WILL_ENTER);
}
function fireDidEvents(enteringEl, leavingEl) {
    lifecycle(enteringEl, __chunk_2.LIFECYCLE_DID_ENTER);
    lifecycle(leavingEl, __chunk_2.LIFECYCLE_DID_LEAVE);
}
