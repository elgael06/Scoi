...
class Toggle {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_4.createColorClasses(color), { [`${mode}`]: true, 'in-item': __chunk_4.hostContext('ion-item', el), 'toggle-activated': activated, 'toggle-checked': checked, 'toggle-disabled': disabled, 'interactive': true })
        };
    }
    __stencil_render() {
        const value = this.getValue();
        __chunk_6.renderHiddenInput(true, this.el, this.name, (this.checked ? value : ''), this.disabled);
        return [
            __chunk_1.h("div", { class: "toggle-icon" }, __chunk_1.h("div", { class: "toggle-inner" })),
