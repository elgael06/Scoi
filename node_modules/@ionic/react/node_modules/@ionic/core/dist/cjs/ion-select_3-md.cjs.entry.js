...
class Select {
    ...
    async openPopover(ev) {
        ...
        return __chunk_3.popoverController.create(popoverOpts);
    }
    async openActionSheet() {
        ...
        return __chunk_3.actionSheetController.create(actionSheetOpts);
    }
    async openAlert() {
        ...
        return __chunk_3.alertController.create(alertOpts);
    }
    /**
    ...
    getLabel() {
        return __chunk_6.findItemLabel(this.el);
    }
    hasValue() {
        return this.getText() !== '';
    }
    ...
    hostData() {
        ...
        const label = __chunk_6.findItemLabel(this.el);
        if (label) {
            label.id = labelId;
        }
        return {
            ...
            class: {
                [`${mode}`]: true,
                'in-item': __chunk_4.hostContext('ion-item', this.el),
                'select-disabled': this.disabled,
            }
        };
    }
    __stencil_render() {
        __chunk_6.renderHiddenInput(true, this.el, this.name, parseValue(this.value), this.disabled);
        const labelId = this.inputId + '-lbl';
        const label = __chunk_6.findItemLabel(this.el);
        if (label) {
            label.id = labelId;
        ...
        return [
            __chunk_1.h("div", { class: selectTextClasses }, selectText),
            __chunk_1.h("div", { class: "select-icon", role: "presentation" }, __chunk_1.h("div", { class: "select-icon-inner" })),
