...
class TabBar {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_4.createColorClasses(color), { [`${mode}`]: true, 'tab-bar-translucent': translucent, 'tab-bar-hidden': keyboardVisible })
        };
    }
    __stencil_render() {
...
class TabButton {
    ...
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
        const { href } = this;
        return (__chunk_1.h("a", { href: href, tabIndex: -1 }, __chunk_1.h("slot", null), mode === 'md' && __chunk_1.h("ion-ripple-effect", { type: "unbounded" })));
    }
    get el() { return __chunk_1.getElement(this); }
    render() { return __chunk_1.h(__chunk_1.Host, this.hostData(), this.__stencil_render()); }
