...
class Loading {
     ...
     */
    async present() {
        await __chunk_3.present(this, 'loadingEnter', iosEnterAnimation, mdEnterAnimation, undefined);
        if (this.duration > 0) {
    ...
    dismiss(data, role) {
        ...
        return __chunk_3.dismiss(this, data, role, 'loadingLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    /**
     * Returns a promise that resolves when the loading did dismiss.
     */
    onDidDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionLoadingDidDismiss');
    }
    /**
     * Returns a promise that resolves when the loading will dismiss.
     */
    onWillDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionLoadingWillDismiss');
    }
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            ...
            class: Object.assign({}, __chunk_4.getClassMap(this.cssClass), { [`${mode}`]: true, 'loading-translucent': this.translucent })
        };
    }
    __stencil_render() {
        return [
            __chunk_1.h("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }),
            __chunk_1.h("div", { class: "loading-wrapper", role: "dialog" }, this.spinner && (__chunk_1.h("div", { class: "loading-spinner" }, __chunk_1.h("ion-spinner", { name: this.spinner }))), this.message && __chunk_1.h("div", { class: "loading-content", innerHTML: __chunk_5.sanitizeDOMString(this.message) }))
        ];
    }
