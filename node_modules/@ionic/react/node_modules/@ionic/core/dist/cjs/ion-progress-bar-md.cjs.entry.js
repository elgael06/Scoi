...
class ProgressBar {
    ...
    hostData() {
        ...
        return {
            ...
            'aria-valuemin': 0,
            'aria-valuemax': 1,
            class: Object.assign({}, __chunk_4.createColorClasses(color), { [`${mode}`]: true, [`progress-bar-${type}`]: true, 'progress-paused': paused, 'progress-bar-reversed': document.dir === 'rtl' ? !reversed : reversed })
        };
    }
    __stencil_render() {
        ...
        const value = __chunk_6.clamp(0, this.value, 1);
        const buffer = __chunk_6.clamp(0, this.buffer, 1);
        return [
