...
class ActionSheet {
     ...
     */
    present() {
        return __chunk_3.present(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
    }
    /**
     ...
     */
    dismiss(data, role) {
        return __chunk_3.dismiss(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    /**
     * Returns a promise that resolves when the action sheet did dismiss.
     */
    onDidDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionActionSheetDidDismiss');
    }
    /**
     ...
     */
    onWillDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionActionSheetWillDismiss');
    }
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({ [`${mode}`]: true }, __chunk_4.getClassMap(this.cssClass), { 'action-sheet-translucent': this.translucent })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
...
function buttonClass(button) {
    return Object.assign({ 'action-sheet-button': true, 'ion-activatable': true, [`action-sheet-${button.role}`]: button.role !== undefined }, __chunk_4.getClassMap(button.cssClass));
}
