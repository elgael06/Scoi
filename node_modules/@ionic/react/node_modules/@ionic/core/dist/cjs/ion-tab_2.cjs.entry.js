...
class Tab {
    ...
    async prepareLazyLoaded() {
        if (!this.loaded && this.component != null) {
            this.loaded = true;
            try {
                return __chunk_7.attachComponent(this.delegate, this.el, this.component, ['ion-page']);
            }
            catch (e) {
                console.error(e);
            }
...
class Tabs {
    ...
    render() {
        return [
            __chunk_1.h("slot", { name: "top" }),
            __chunk_1.h("div", { class: "tabs-inner" }, __chunk_1.h("slot", null)),
            __chunk_1.h("slot", { name: "bottom" })
        ];
    }
    get el() { return __chunk_1.getElement(this); }
