...
class ItemOption {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { [`${mode}`]: true, 'item-option-disabled': disabled, 'item-option-expandable': expandable, 'ion-activatable': true })
        };
    }
    __stencil_render() {
        const TagType = this.href === undefined ? 'button' : 'a';
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(TagType, { type: "button", class: "button-native", disabled: this.disabled, href: this.href }, __chunk_1.h("span", { class: "button-inner" }, __chunk_1.h("slot", { name: "top" }), __chunk_1.h("div", { class: "horizontal-wrapper" }, __chunk_1.h("slot", { name: "start" }), __chunk_1.h("slot", { name: "icon-only" }), __chunk_1.h("slot", null), __chunk_1.h("slot", { name: "end" })), __chunk_1.h("slot", { name: "bottom" })), mode === 'md' && __chunk_1.h("ion-ripple-effect", null)));
    }
...
class ItemOptions {
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        const isEnd = __chunk_6.isEndSide(this.win, this.side);
        return {
            class: {
                [`${mode}`]: true,
...
class ItemSliding {
    ...
    async open(side) {
        ...
        side = __chunk_6.isEndSide(window, side) ? 'end' : 'start';
    ...
    async updateOptions() {
        ...
        for (let i = 0; i < options.length; i++) {
            ...
            const side = __chunk_6.isEndSide(window, option.side) ? 'end' : 'start';
            if (side === 'start') {
