...
class Modal {
    ...
    async present() {
        ...
        this.usersElement = await __chunk_7.attachComponent(this.delegate, container, this.component, ['ion-page'], componentProps);
        await __chunk_8.deepReady(this.usersElement);
        return __chunk_3.present(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation);
    }
    /**
    ...
    async dismiss(data, role) {
        const dismissed = await __chunk_3.dismiss(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation);
        if (dismissed) {
     ...
     */
    onDidDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionModalDidDismiss');
    }
    /**
     * Returns a promise that resolves when the modal will dismiss.
     */
    onWillDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionModalWillDismiss');
    }
    hostData() {
        ...
        return {
            'no-router': true,
            'aria-modal': 'true',
            class: Object.assign({ [`${mode}`]: true }, __chunk_4.getClassMap(this.cssClass)),
            style: {
