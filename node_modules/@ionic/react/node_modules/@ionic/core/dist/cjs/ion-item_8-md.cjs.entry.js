...
class Item {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, childStyles, __chunk_4.createColorClasses(this.color), { 'item': true, [`${mode}`]: true, [`item-lines-${this.lines}`]: this.lines !== undefined, 'item-disabled': this.disabled, 'in-list': __chunk_4.hostContext('ion-list', this.el), 'item-multiple-inputs': this.multipleInputs, 'ion-activatable': this.isClickable(), 'ion-focusable': true })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
        ...
        return [
            __chunk_1.h(TagType, Object.assign({}, attrs, { class: "item-native", disabled: this.disabled, onClick: (ev) => __chunk_4.openURL(win, href, ev, routerDirection) }), __chunk_1.h("slot", { name: "start" }), __chunk_1.h("div", { class: "item-inner" }, __chunk_1.h("div", { class: "input-wrapper" }, __chunk_1.h("slot", null)), __chunk_1.h("slot", { name: "end" }), showDetail && __chunk_1.h("ion-icon", { icon: detailIcon, lazy: false, class: "item-detail-icon" }), __chunk_1.h("div", { class: "item-inner-highlight" })), clickable && mode === 'md' && __chunk_1.h("ion-ripple-effect", null)),
            __chunk_1.h("div", { class: "item-highlight" })
        ];
    }
...
class ItemDivider {
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { [`${mode}`]: true, 'item-divider-sticky': this.sticky, 'item': true })
        };
    }
    __stencil_render() {
        return [
...
class Label {
    ...
    hostData() {
        ...
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { [`${mode}`]: true, [`label-${position}`]: position !== undefined, [`label-no-animate`]: (this.noAnimate) })
        };
    }
    get el() { return __chunk_1.getElement(this); }
...
class ListHeader {
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { [`${mode}`]: true })
        };
    }
    __stencil_render() {
...
class SkeletonText {
    ...
    hostData() {
        ...
        const inMedia = __chunk_4.hostContext('ion-avatar', this.el) || __chunk_4.hostContext('ion-thumbnail', this.el);
        const mode = __chunk_1.getIonMode(this);
