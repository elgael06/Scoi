...
class Alert {
     ...
     */
    present() {
        return __chunk_3.present(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
    }
    /**
     ...
     */
    dismiss(data, role) {
        return __chunk_3.dismiss(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    /**
     * Returns a promise that resolves when the alert did dismiss.
     */
    onDidDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionAlertDidDismiss');
    }
    /**
     * Returns a promise that resolves when the alert will dismiss.
     */
    onWillDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionAlertWillDismiss');
    }
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_4.getClassMap(this.cssClass), { [`${mode}`]: true, 'alert-translucent': this.translucent })
        };
    }
    renderAlertButtons() {
...
function buttonClass(button) {
    return Object.assign({ 'alert-button': true, 'ion-focusable': true, 'ion-activatable': true }, __chunk_4.getClassMap(button.cssClass));
}
