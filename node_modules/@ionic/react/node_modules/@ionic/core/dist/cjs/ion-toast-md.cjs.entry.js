...
const __chunk_5 = require('./chunk-31bc374f.js');
...
class Toast {
     ...
     */
    async present() {
        await __chunk_3.present(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position);
        if (this.duration > 0) {
    ...
    dismiss(data, role) {
        ...
        return __chunk_3.dismiss(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
    }
    /**
     * Returns a promise that resolves when the toast did dismiss.
     */
    onDidDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionToastDidDismiss');
    }
    /**
     * Returns a promise that resolves when the toast will dismiss.
     */
    onWillDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionToastWillDismiss');
    }
    getButtons() {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({ [`${mode}`]: true }, __chunk_4.createColorClasses(this.color), __chunk_4.getClassMap(this.cssClass), { 'toast-translucent': this.translucent })
        };
    }
    ...
    __stencil_render() {
        ...
        return (__chunk_1.h("div", { class: wrapperClass }, __chunk_1.h("div", { class: "toast-container" }, this.renderButtons(startButtons, 'start'), __chunk_1.h("div", { class: "toast-content" }, this.header !== undefined &&
            ...
            __chunk_1.h("div", { class: "toast-message", innerHTML: __chunk_5.sanitizeDOMString(this.message) })), this.renderButtons(endButtons, 'end'))));
    }
...
function buttonClass(button) {
    return Object.assign({ 'toast-button': true, 'toast-button-icon-only': button.icon !== undefined && button.text === undefined, [`toast-button-${button.role}`]: button.role !== undefined, 'ion-focusable': true, 'ion-activatable': true }, __chunk_4.getClassMap(button.cssClass));
}
