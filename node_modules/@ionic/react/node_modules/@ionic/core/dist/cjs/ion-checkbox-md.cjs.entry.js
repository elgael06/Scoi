...
class Checkbox {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, __chunk_4.createColorClasses(color), { [`${mode}`]: true, 'in-item': __chunk_4.hostContext('ion-item', el), 'checkbox-checked': checked, 'checkbox-disabled': disabled, 'checkbox-indeterminate': this.indeterminate, 'interactive': true })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
        __chunk_6.renderHiddenInput(true, this.el, this.name, (this.checked ? this.value : ''), this.disabled);
        ...
        return [
            __chunk_1.h("svg", { class: "checkbox-icon", viewBox: "0 0 24 24" }, path),
