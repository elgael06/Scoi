...
class InfiniteScrollContent {
    ...
    __stencil_render() {
        return (__chunk_1.h("div", { class: "infinite-loading" }, this.loadingSpinner && (__chunk_1.h("div", { class: "infinite-loading-spinner" }, __chunk_1.h("ion-spinner", { name: this.loadingSpinner }))), this.loadingText && (__chunk_1.h("div", { class: "infinite-loading-text", innerHTML: __chunk_5.sanitizeDOMString(this.loadingText) }))));
    }
