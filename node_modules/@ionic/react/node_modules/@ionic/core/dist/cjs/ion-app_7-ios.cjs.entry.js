...
const __chunk_4 = require('./chunk-cb723cc6.js');
...
function importHardwareBackButton(win, config) {
    const hardwareBackConfig = config.getBoolean('hardwareBackButton', __chunk_1.isPlatform(win, 'hybrid'));
    if (hardwareBackConfig) {
        Promise.resolve(require('./hardware-back-button-945ba9a4.js')).then(module => module.startHardwareBackButton(win));
    }
}
function importStatusTap(win, config) {
    const statusTap = config.getBoolean('statusTap', __chunk_1.isPlatform(win, 'hybrid'));
    if (statusTap) {
        Promise.resolve(require('./status-tap-d29c72dd.js')).then(module => module.startStatusTap(win));
    }
}
function importFocusVisible(win) {
    Promise.resolve(require('./focus-visible-41c2e933.js')).then(module => module.startFocusVisible(win.document));
}
function importTapClick(win, config) {
    Promise.resolve(require('./tap-click-65b1cc17.js')).then(module => module.startTapClick(win.document, config));
}
function importInputShims(win, config) {
    const inputShims = config.getBoolean('inputShims', needInputShims(win));
    if (inputShims) {
        Promise.resolve(require('./input-shims-0680a6e0.js')).then(module => module.startInputShims(win.document, config));
    }
}
function needInputShims(win) {
    return __chunk_1.isPlatform(win, 'ios') && __chunk_1.isPlatform(win, 'mobile');
}
...
class Content {
    ...
    componentWillLoad() {
        if (this.forceOverscroll === undefined) {
            const mode = __chunk_1.getIonMode(this);
            this.forceOverscroll = mode === 'ios' && __chunk_1.isPlatform(this.win, 'mobile');
        }
    }
    componentDidLoad() {
        this.resize();
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_4.createColorClasses(this.color), { [`${mode}`]: true, 'content-sizing': __chunk_4.hostContext('ion-popover', this.el), 'overscroll': !!this.forceOverscroll }),
            style: {
    ...
    __stencil_render() {
        ...
        return [
            __chunk_1.h("div", { class: {
                ...
                }, ref: el => this.scrollEl = el, onScroll: ev => this.onScroll(ev) }, __chunk_1.h("slot", null)),
            __chunk_1.h("slot", { name: "fixed" })
        ];
    }
    get el() { return __chunk_1.getElement(this); }
...
class ToolbarTitle {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({ [`${mode}`]: true, [`title-${mode}`]: true }, __chunk_4.createColorClasses(this.color))
        };
    }
    __stencil_render() {
        return [
...
class Toolbar {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({ [`${mode}`]: true }, childStyles, __chunk_4.createColorClasses(this.color))
        };
    }
    __stencil_render() {
        return [
            __chunk_1.h("div", { class: "toolbar-background" }),
            __chunk_1.h("div", { class: "toolbar-container" }, __chunk_1.h("slot", { name: "start" }), __chunk_1.h("slot", { name: "secondary" }), __chunk_1.h("div", { class: "toolbar-content" }, __chunk_1.h("slot", null)), __chunk_1.h("slot", { name: "primary" }), __chunk_1.h("slot", { name: "end" }))
        ];
    }
    get el() { return __chunk_1.getElement(this); }
    render() { return __chunk_1.h(__chunk_1.Host, this.hostData(), this.__stencil_render()); }
