...
class Router {
    ...
    componentDidLoad() {
        this.win.addEventListener('ionRouteRedirectChanged', __chunk_6.debounce(this.onRedirectChanged.bind(this), 10));
        this.win.addEventListener('ionRouteDataChanged', __chunk_6.debounce(this.onRoutesChanged.bind(this), 100));
    }
    onPopState() {
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await Promise.resolve(require('./swipe-back-a1d2f1d5.js'))).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
