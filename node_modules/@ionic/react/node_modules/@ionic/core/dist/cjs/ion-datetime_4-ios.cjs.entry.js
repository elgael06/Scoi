...
const __chunk_3 = require('./chunk-6d230a70.js');
const __chunk_4 = require('./chunk-cb723cc6.js');
const __chunk_6 = require('./chunk-dfe34003.js');
const __chunk_9 = require('./chunk-2fa482f4.js');
...
class Datetime {
    ...
    async open() {
        ...
        const picker = await __chunk_3.pickerController.create(pickerOptions);
    ...
    async validateColumn(picker, name, index, min, max, lowerBounds, upperBounds) {
        ...
        const selectedIndex = column.selectedIndex = __chunk_6.clamp(indexMin, column.selectedIndex, indexMax);
    ...
    hostData() {
        ...
        const label = __chunk_6.findItemLabel(el);
        if (label) {
            label.id = labelId;
        }
        return {
            ...
            class: {
                ...
                'in-item': __chunk_4.hostContext('ion-item', el)
            }
        };
    }
    __stencil_render() {
        ...
        __chunk_6.renderHiddenInput(true, this.el, this.name, this.value, this.disabled);
        return [
            __chunk_1.h("div", { class: "datetime-text" }, datetimeText),
            __chunk_1.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: el => this.buttonEl = el })
        ];
    }
...
class Picker {
     ...
     */
    async present() {
        await __chunk_3.present(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined);
        if (this.duration > 0) {
    ...
    dismiss(data, role) {
        ...
        return __chunk_3.dismiss(this, data, role, 'pickerLeave', iosLeaveAnimation, iosLeaveAnimation);
    }
    /**
     * Returns a promise that resolves when the picker did dismiss.
     */
    onDidDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionPickerDidDismiss');
    }
    /**
     * Returns a promise that resolves when the picker will dismiss.
     */
    onWillDismiss() {
        return __chunk_3.eventMethod(this.el, 'ionPickerWillDismiss');
    }
    /**
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({ [`${mode}`]: true,
                ...
                [`picker-${mode}`]: true }, __chunk_4.getClassMap(this.cssClass)),
            style: {
...
function buttonClass(button) {
    return Object.assign({ 'picker-button': true, 'ion-activatable': true }, __chunk_4.getClassMap(button.cssClass));
}
...
class PickerColumnCmp {
    ...
    async componentDidLoad() {
        ...
        this.refresh();
        this.gesture = (await Promise.resolve(require('./index-e432ed5f.js'))).createGesture({
            el: this.el,
    ...
    update(y, duration, saveY) {
        ...
        if (this.lastIndex !== selectedIndex) {
            ...
            __chunk_9.hapticSelectionChanged();
    ...
    onEnd(detail) {
        ...
        this.velocity = __chunk_6.clamp(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    refresh(forceRefresh) {
        ...
        const selectedIndex = __chunk_6.clamp(min, this.col.selectedIndex || 0, max);
...
class PickerController {
     ...
     */
    create(options) {
        return __chunk_3.createOverlay('ion-picker', options);
    }
    /**
    ...
    dismiss(data, role, id) {
        return __chunk_3.dismissOverlay(document, data, role, 'ion-picker', id);
    }
    /**
     * Get the most recently opened picker overlay.
     */
    async getTop() {
        return __chunk_3.getOverlay(document, 'ion-picker');
    }
}
