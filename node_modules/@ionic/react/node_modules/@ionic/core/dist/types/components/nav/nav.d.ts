...
import { AnimationBuilder, ComponentProps, Config, FrameworkDelegate, NavComponent, NavOptions, NavOutlet, RouteID, RouteWrite, RouterDirection, TransitionDoneFn, ViewController } from '../../interface';
