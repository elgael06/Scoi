...
export class Searchbar {
    ...
    render() {
        ...
        const cancelButton = this.showCancelButton && (h("button", { type: "button", tabIndex: mode === 'ios' && !this.focused ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" },
            h("div", null, mode === 'md'
    ...
    static get properties() { return {
        ...
        "showCancelButton": {
            ...
            "docs": {
                "tags": [],
                "text": "If `true`, show the cancel button."
            },
